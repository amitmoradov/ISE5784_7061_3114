...
//              .setRayTracer(new SimpleRayTracer(scene));
      ...
      scene.geometries.add(
              ...
              new Sphere(new Point(50, -20, -100), 30d).setEmission(new Color(250, 140, 4))
                      .setMaterial(new Material().setKd(0.2).setKs(0.2).setShininess(30))
              // Sphere inside sphere with transparency
                , new Sphere(new Point(-50, -90, -68), 30d).setEmission(new Color(70,0,10))
                        .setMaterial(new Material().setKd(0.5).setKs(0.5).setKT(0.5).setShininess(100))
      ...
      cameraBuilder.setLocation(new Point(0, 0, 1000)).setVpDistance(1000).setVpSize(200, 200)
              .setImageWriter(new ImageWriter("AllItemsF", 600, 600)).build().renderImage().writeToImage();
